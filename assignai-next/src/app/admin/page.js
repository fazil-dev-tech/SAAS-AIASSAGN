      ...
      <AnimatePresence>
        {viewingReport && (
          ...
          >
            ...
            >
              {/* Toolbar */}
              <div style={{ padding: '1rem 2rem', background: '#ffffff', borderBottom: '1px solid rgba(226,232,240,1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 10 }}>
                <div>
